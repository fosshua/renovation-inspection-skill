# deployable-miniapp-api Specification

## Purpose
Define the deployable API surface that lets the home-renovation assistant receive WeChat official-account callbacks and WeChat Mini Program inspection requests, then route them through an inspection backend, model provider, or fallback response.
