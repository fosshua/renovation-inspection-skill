...
Defines the behavior of the renovation inspection skill, including multimodal input handling, visible construction issue detection, standards-backed assessment, reference-image comparison, severity ranking, actionable recommendations, structured output, and privacy-aware media handling.
